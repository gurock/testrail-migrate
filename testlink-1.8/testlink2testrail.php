...
{	
	...
	{	
		xml_write_html_tag($handle, 'preconds', $case->summary);
	}

	if (isset($case->steps))
	{
		xml_write_html_tag($handle, 'steps', $case->steps);
	}

	if (isset($case->expectedresults))
	{
		xml_write_html_tag($handle, 'expected', $case->expectedresults);
	}
